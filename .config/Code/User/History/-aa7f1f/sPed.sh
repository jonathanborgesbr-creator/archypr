...
sudo pacman -S --noconfirm pipewire pipewire-pulse pipewire-jack pipewire-alsa pipewire-media-session wireplumber \
...
su - "$USUARIO" -c "systemctl --user --now enable pipewire.socket pipewire-pulse.service wireplumber.service bluetooth.service" 
...
sudo systemctl enable --now NetworkManager
 sudo pacman -S pipewire-media-session bluez-utils
